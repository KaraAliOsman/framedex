...
| **SHOT-06** | 1 · s4–5 | PRD-01 completo, F1 | **IMPLEMENTADO — PR #14 EN REVISIÓN**: SLIDING_2L, DOOR_ENTRY, AWNING, `hardware_kits`, peso+fallback, pricing puro. Gauntlet local EXIT CODE 0; [PR protegido](https://github.com/KaraAliOsman/framedex/pull/14). Evidencia en `docs/plans/PLAN_SHOT-06.md`; NO MERGE | **Core Gate Obligatorio:** G5, G6, G7 pasan $0.00\text{ mm}$ + test CI de `golden_example.json` bit a bit. *(Extended Gate: G8, G9, G11, G12 diferibles a SHOT-06B; G10 en Fase 4)* |
