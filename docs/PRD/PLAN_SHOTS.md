...
| **SHOT-20** | 3 · s18–20 | PRD-20-CATALOGO-GLOBAL, S28 | Catálogo global + cola admin (Pantalla S28) | Flujo solicitud $\rightarrow$ revisión $\rightarrow$ publicación sin precios; **test: admin no puede consultar costos ajenos** (blindaje) |
