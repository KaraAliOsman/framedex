...
| **SHOT-03** | 0 · s2–3 | PRD-01 §§2–4, §5.1 y §6 (sólo G1–G4); PRD-04 §2 (árbol); PRD-FRONTEND §1.1 (compatibilidad BOM) | Engine núcleo: models, geometry FIXED/TURN/TILT_TURN/MULLION, BOM base | `pytest engine/`: **G1, G2, G3, G4 en 0.00**; G8/G9/G11/G12 en xfail declarado |
