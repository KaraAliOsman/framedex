...
| **SHOT-06** | 1 · s4–5 | PRD-01 completo, F1 | **EN EJECUCIÓN — FASE 2 AUTORIZADA**: SLIDING_2L, DOOR_ENTRY, AWNING, resolución `hardware_kits`, peso+fallback, pricing puro. Evidencia en `docs/plans/PLAN_SHOT-06.md`; sin merge | **Core Gate Obligatorio:** G5, G6, G7 pasan $0.00\text{ mm}$ + test CI de `golden_example.json` bit a bit. *(Extended Gate: G8, G9, G11, G12 diferibles a SHOT-06B; G10 en Fase 4)* |
