...
|---|---|---|
| `PROVEN` | Implementation closed and merged with the evidence required by Constitution Rule 19; scope remains bounded by its shot. | Closed SHOT, merged PR with 4 green CI checks, passing tests, RLS, or Golden. |
...
| **SHOT-10** | Project Versioning & Catalog CRUD | `PROVEN` | [PR #34](https://github.com/KaraAliOsman/framedex/pull/34) merged in `main` at `8712d67f66601cd63209128ee29fe2a043d9b755`; full Gauntlet EXIT 0 on `85893c365a7228ef5805afe1e8292d1335ddc8dc`; narrow executable refinement ended at `4e1f7af367438f11a723e20f22fc771177a0ce40`; documentation head `99f18562f0378712d0db668abcd6f47b15e9c5ff`; protected CI 4/4 green on PR and merge; tag `shot-10` → `8712d67`; [closure evidence](./plans/PLAN_SHOT-10.md). |
| **SHOT-11** | Flow.cl Billing & Ledger Integration | `IN_PROGRESS` | [PR #38](https://github.com/KaraAliOsman/framedex/pull/38): OWNER authorizes protected integration with paid activation deferred (PD-11-05). Native subscriptions, transactional trial/ledger, OWNER S20/S24, canonical Gauntlet and synthetic encrypted restore evidence are recorded in the [plan](./plans/PLAN_SHOT-11.md). PostgreSQL 17 is approved; real Flow adjustments/checkout, deployment/alerts and managed recovery remain pending. No closure tag. |
