...
| **SHOT-11** | Flow.cl Billing & Ledger Integration | `IN_PROGRESS` | Draft [PR #38](https://github.com/KaraAliOsman/framedex/pull/38); atomic trial/wallet and verified payment settlement, OWNER S20/S24 read surfaces, local Gunicorn/Redis and encrypted clean-restore proof. Native subscription orchestration, PD-11-02/03 and external production gates remain open; [SHA-bound evidence](./plans/PLAN_SHOT-11.md). No closure Gauntlet, merge or tag. |
