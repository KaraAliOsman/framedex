# ARCHIVED v1.2 — Usar SCREENS_SPECIFICATION_S01_S28.md.

# ESPECIFICACIÓN CANÓNICA DE PANTALLAS (S01 – S27) (v1.1.1)
**Estado:** Bloqueado / Congelado  
**Total Pantallas:** 27 pantallas completas  
**Stack UI:** React 18 + Tailwind CSS + TanStack Query + Zustand

---

## Índice y Mapeo de Rutas de Pantallas (S01 a S27)
...
| **S13** | Catálogo de Perfiles y Series | `/catalog/systems` | OWNER, WORKSHOP_MANAGER |
| **S14** | Compilador de Catálogos Asistido por IA | `/catalog/compiler` | OWNER |
| **S15** | Matriz Junquillo–Vidrio | `/catalog/systems/:id/glazing` | OWNER, WORKSHOP_MANAGER |
...
| **S19** | Optimizador y Mapa de Corte 1D | `/orders/ot/:id/cutting-plan` | WORKSHOP_MANAGER |
...
| **S24** | Suscripción y Facturación (Starter/Pro/Business) | `/settings/billing` | OWNER |
| **S25** | Configuración General y Políticas RLS | `/settings/general` | OWNER |
| **S26** | Portal Público de Firma de Cotizaciones | `/p/quote/:uuid` | Cliente Final (Público) |
