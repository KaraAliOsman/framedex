"""Populated pre-documentary project_versions upgrade on PostgreSQL 16.

Builds the pre-documentary schema, inserts a legitimate legacy project_version,
applies the documentary-and-later migrations, and proves the row survives
unchanged as typed PRE_SHOT09 evidence that cannot masquerade as a V1 revision,
while new V1 revisions still require the complete strict authority contract.
"""
