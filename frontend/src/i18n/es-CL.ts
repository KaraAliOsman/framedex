...
export const messages = {
  ...
  "jobs.fail.notFound": "No encuentra su referencia — el proyecto o la revisión cambió. Reemite desde el proyecto.",
  "jobs.fail.permission": "Tu rol no permite completar este trabajo.",
  "jobs.fail.storage": "El almacenamiento de documentos falló. Reintenta; si persiste, revisa la configuración.",
  ...
  "jobs.fail.invalid": "Los datos del trabajo no son válidos — revisa la configuración antes de reintentar.",
